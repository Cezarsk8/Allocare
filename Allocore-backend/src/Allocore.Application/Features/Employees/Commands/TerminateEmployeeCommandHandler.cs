...
public class TerminateEmployeeCommandHandler : IRequestHandler<TerminateEmployeeCommand, Result>
{
    ...
    public async Task<Result> Handle(TerminateEmployeeCommand command, CancellationToken cancellationToken)
    {
        ...
        employee.Terminate(command.Request.TerminationDate);
